    ...
    <header className="fixed-header">
      ...
      <nav className="main-nav">
        <div className="logo">
          <Link to="/" style={{ display: "flex", alignItems: "center", textDecoration: "none", color: "inherit" }}>
            ...
            <span className="brand-name" style={{ color: "white" }}>appinventiv</span>
          </Link>
        </div>
        ...
        <ul className="nav-links desktop-only">
          {navLinks.map((link) => (
            <li key={link} className="nav-item">
              {link === "InventivAI" ? (
                <Link to="/inventiveai" style={{ color: "inherit", textDecoration: "none" }}>
                  {link}
                </Link>
              ) : (
                link
      ...
      <div className={`sidebar ${isOpen ? "open" : ""}`}>
        ...
        <ul className="sidebar-links">
          {navLinks.map((link) => (
            <li key={link} className="sidebar-item" onClick={() => setIsOpen(false)}>
              {/* This conditional logic makes the mobile text clickable */}
              {link === "InventivAI" ? (
                <Link 
                  to="/inventiveai" 
          ...
          <li className="sidebar-item">
            <Link to="/contact" className="mobile-contact-link" onClick={() => setIsOpen(false)}>
              Contact Us
            </Link>
          </li>
        </ul>
